...
import com.yachiyo.ContentService.entity.*;
import com.yachiyo.ContentService.enumeration.InteractionAction;
import com.yachiyo.ContentService.enumeration.InteractionType;
import com.yachiyo.ContentService.enumeration.TradeType;
import com.yachiyo.ContentService.mapper.*;
        ...
        try {
            ...
            for (String fileName : fileClient.getNames(userId + "/" + postingEntity.getTitle())) {
                if (fileName.startsWith("\\d+")) {
                    files.add(fileClient.getUrl(userId + "/" + postingEntity.getTitle() + "/" + fileName, 60 * 5, "update"));
                }
            }
